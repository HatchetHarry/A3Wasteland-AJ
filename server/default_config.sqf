...
A3W_maxFatigue = 0.5;				// Set maximum value of fatigue for players 0.5 = 50%, 1 = script disabled, if you want unlimited stamina set this to 1 and unlimited stamina to 1
...
A3W_objectLifetime = 14*24;         // Maximum lifetime in hours for saved objects (baseparts, crates, etc.) across server restarts (0 = no time limit)
