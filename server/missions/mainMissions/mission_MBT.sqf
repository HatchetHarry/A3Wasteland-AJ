...
//if (!isServer) exitwith {};
	...
	_result = 0;
	_missionMarkerName = "MBT_Marker" + str time + str (random 1000000);
	...
	_vehicleClass = ["B_MBT_01_cannon_F", "O_MBT_02_cannon_F","I_MBT_03_cannon_F"] call BIS_fnc_selectRandom;
