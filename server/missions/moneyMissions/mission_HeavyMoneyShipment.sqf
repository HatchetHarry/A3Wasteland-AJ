...
if((!hasInterface && !isServer) || isServer) then
	...
	_missionMarkerName = "Money_Shipment" + str time + str (random 1000000);
	...
	_MoneyShipmentVeh = 
	[
		["BUS_TankPlatoon_AA", "BUS_MechInf_AT"],
		["BUS_MechInf_AT", "BUS_TankPlatoon_AA"],
		["BUS_TankPlatoon_AA", "BUS_MechInf_AT"]
	]
